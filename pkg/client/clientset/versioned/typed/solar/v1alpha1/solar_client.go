...
// ExampleV1alpha1Client is used to interact with features provided by the example.crd.com group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) Stars(namespace string) StarInterface {
